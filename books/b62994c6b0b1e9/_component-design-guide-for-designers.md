...
大事なのは、いま自分たちがこのスペクトラムのどこにいるかを自覚し、意図的に選ぶことです。なんとなく共通化する、なんとなく専用のものを作る。この無自覚さが、経路依存性を通じて後から修正しにくい構造を生みます。この問いは以降の章で繰り返し登場しますが、正解がひとつに定まらないからこそ、判断の軸を持っておくことに価値があります。
