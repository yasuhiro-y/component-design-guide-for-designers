...
![追加と削除の非対称性: 5分で追加、数週間で削除](/images/books/b62994c6b0b1e9/fig-81.png)
...
![意図的な妥協: 無自覚な場当たりとの違い](/images/books/b62994c6b0b1e9/fig-80.png)
...
![一般化と個別化のスペクトラム](/images/books/b62994c6b0b1e9/fig-79.png)
...
![コンポーネント設計の8つの観点](/images/books/b62994c6b0b1e9/fig-31.png)
...
![コンポーネント化の判断フロー](/images/books/b62994c6b0b1e9/fig-01.png)
...
![Atomic Design: 5つの階層](/images/books/b62994c6b0b1e9/fig-40.png)
...
![Feature-Sliced Design の3層構造](/images/books/b62994c6b0b1e9/fig-02.png)
...
![汎用コンポーネントとドメインコンポーネントの依存関係](/images/books/b62994c6b0b1e9/fig-03.png)
...
![汎用コンポーネントの例: どのサービスでも使い回せる部品](/images/books/b62994c6b0b1e9/fig-59.png)
...
![ドメインコンポーネントの例: 特定のデータ構造に特化した部品](/images/books/b62994c6b0b1e9/fig-60.png)
...
![汎用かドメインか: 視点で答えが変わる](/images/books/b62994c6b0b1e9/fig-32.png)
...
![早すぎる共通化の罠: プロパティ肥大化](/images/books/b62994c6b0b1e9/fig-20.png)
...
![MUI: Chip（操作できる）と Badge（見るだけ）](/images/books/b62994c6b0b1e9/fig-12.png)
...
![Ant Design: Tag と Badge](/images/books/b62994c6b0b1e9/fig-13.png)
...
![ライブラリ間の命名収束: 同じ概念には同じ名前が定着している](/images/books/b62994c6b0b1e9/fig-74.png)
...
![命名: 状態を名前に含めると組み合わせが爆発する](/images/books/b62994c6b0b1e9/fig-26.png)
...
![データモデルとコンポーネント名: 揃えるか、離すか](/images/books/b62994c6b0b1e9/fig-66.png)
...
![同じオブジェクトを受け取り、レイアウトだけが異なる](/images/books/b62994c6b0b1e9/fig-68.png)
...
![レイアウトバリエーションの命名: 形状で分けるか、場所で分けるか](/images/books/b62994c6b0b1e9/fig-69.png)
...
設計は紙の上では美しくまとまりますが、現実のプロダクト開発は常に紙の外側にあります。ここからは、設計したコンポーネントを運用する中で直面する現実的な課題と、その対処法を扱います。
...
![安全な変更と破壊的変更: 増やすのは簡単、変えるのは大変](/images/books/b62994c6b0b1e9/fig-27.png)
...
変更を提案するときに「この変更、実装側ではどれくらいの影響がありますか？」とエンジニアに率直に聞くこと自体が、チームの信頼関係を強化します。トークンを整備したおかげでブランドカラー変更が1日で完了した、命名規則を統一したおかげでオンボーディングが短縮された——こうした具体的な効果を記録していく習慣が、デザインシステムへの継続的な投資を支えます。

![追加と削除の非対称性: 似たバリアントは増えやすく、減らしにくい](/images/books/b62994c6b0b1e9/fig-70.png)
...
後から体系化しようとすると、参照箇所すべてを書き換える破壊的変更になります。中身の値は後で変えられますが、階層構造の変更は影響が大きい。だからこそ、構造だけは早めに固めておく価値があります。
...
![不確実性が高いときの構造設計: 器の形だけ先に決める](/images/books/b62994c6b0b1e9/fig-82.png)
...
![既存コンポーネントで実現できないとき: 4つの選択肢](/images/books/b62994c6b0b1e9/fig-43.png)
...
逸脱を罰するのではなく、逸脱からシステムを改善するフィードバックループを回すこと。違反を取り締まるトークン警察ではなく、正しい選択が自然にできる環境を設計することが、強制よりもはるかに高い準拠率につながります。
...
![デザインシステムの進化サイクル](/images/books/b62994c6b0b1e9/fig-51.png)

### 場当たり対応の連鎖: ハックがハックを呼ぶ構造

ここで、ひとつの特別対応がどのように雪だるま式に膨らんでいくか、具体的なシナリオを見てみましょう。極論めいた話ですが、似た状況に心当たりがある方は少なくないはずです。
...
![場当たり対応の連鎖: ハックがハックを呼ぶ構造](/images/books/b62994c6b0b1e9/fig-83.png)
...
![コンポーネントのライフサイクル](/images/books/b62994c6b0b1e9/fig-22.png)
...
![非推奨化のワークフロー: 告知から削除までの4ステップ](/images/books/b62994c6b0b1e9/fig-76.png)
...
![Figma プロパティパネルとコードの対応関係](/images/books/b62994c6b0b1e9/fig-18.png)
...
![プロパティの型: Figma での見え方とコードの対応](/images/books/b62994c6b0b1e9/fig-17.png)
...
![Boolean の矛盾: 2つのトグルより1つの Enum](/images/books/b62994c6b0b1e9/fig-42.png)

![Boolean×2 の矛盾 vs Enum×1 のシンプルさ](/images/books/b62994c6b0b1e9/fig-75.png)
...
もうひとつ知っておきたいのは、Booleanにはまだ決まっていないという状態がないということです。Figmaのトグルスイッチと同じで、ONかOFFか、必ずどちらかの状態にあります。だからこそ、コンポーネントを新しく作ったとき、そのトグルの初期状態をONにするかOFFにするかをあらかじめ決めておく必要があります。
...
String型は何でも入力できますが、自由すぎるとチームのなかでバラつきが生まれます。Enumにして選択肢を絞ることで、迷う場面が減り本質に集中できる。選択肢の体系そのものが、コンポーネントの使い方を暗に伝えてくれます。デッドライン直前のように急いでいるときにこそ、正しい選択が最も簡単であることが効きます。
...
コンポーネント名やプロパティ名はレビューしていても、Enumの選択肢名まで見ていないチームは多いです。しかし、選択肢の名前こそ後から最も変えにくい部分です。追加は安全ですが、既存の選択肢名の変更は破壊的変更にあたります。
...
![色のセマンティクス: 見た目ではなく役割で名付ける](/images/books/b62994c6b0b1e9/fig-61.png)
...
![Chakra UI: Badge と Tag の colorScheme バリエーション](/images/books/b62994c6b0b1e9/fig-16.png)
...
![String型: テキストの振る舞い6パターン](/images/books/b62994c6b0b1e9/fig-33.png)
...
![Number型: 数値の表示ルール](/images/books/b62994c6b0b1e9/fig-45.png)
...
![Date型: 日付の表示形式と設計判断](/images/books/b62994c6b0b1e9/fig-46.png)
...
![配列: 同じテンプレートに異なるデータを流し込む](/images/books/b62994c6b0b1e9/fig-62.png)

同じ器に異なるデータを流し込む。これが配列型のUIの特徴です。各要素のテキストの内容、`Tag`の有無、ステータスの色はそれぞれ異なりますが、コンポーネント自体は同じものが使い回されます。

![Array型: リストの4つの状態](/images/books/b62994c6b0b1e9/fig-34.png)
...
![オブジェクト: 複数の値をひとかたまりで渡す](/images/books/b62994c6b0b1e9/fig-63.png)
...
![Object型: 個別の値 vs データのまとまり](/images/books/b62994c6b0b1e9/fig-47.png)

### Element: 要素

ここまでの型（Boolean、Enum、String、Numberなど）はすべて、テキストや数値といったデータを渡すものでした。しかし、プロパティに渡したいのがデータではなく、別のコンポーネントそのものというケースがあります。

![Button のスロット構造: 差し込み口を設けることでバリアント爆発を防ぐ](/images/books/b62994c6b0b1e9/fig-04.png)
...
![バリアント爆発 vs スロット: 4つ作るか、1つで済ませるか](/images/books/b62994c6b0b1e9/fig-71.png)
...
![Element型（スロット）: 差し込み口で中身を自由に](/images/books/b62994c6b0b1e9/fig-48.png)
...
![Configuration vs Composition: 設定の山か、組み合わせか](/images/books/b62994c6b0b1e9/fig-50.png)
...
数学的には座標のX軸を動かしてもY軸は動かないことを指しますが、ここでの意味はもっとシンプルです。Figmaのバリアントで`size`を変えても`variant`の見た目に影響しない。この独立性のことです。
...
![直交性: size と variant の組み合わせがすべて成立する](/images/books/b62994c6b0b1e9/fig-05.png)
...
![直交性: colorScheme と variant の組み合わせマトリクス](/images/books/b62994c6b0b1e9/fig-28.png)
...
![直交性の崩れ: 1つのプロパティに混ぜる vs 分離する](/images/books/b62994c6b0b1e9/fig-67.png)
...
![トークンの共有: 複数コンポーネントの一貫性を保つ](/images/books/b62994c6b0b1e9/fig-06.png)
...
![トークン変更の波及: 1箇所の変更が全コンポーネントに届く](/images/books/b62994c6b0b1e9/fig-78.png)
...
![必須と任意: デフォルト値で使いやすさが決まる](/images/books/b62994c6b0b1e9/fig-36.png)
...
![条件付き表示: Figmaでは2つ、コードでは1つ](/images/books/b62994c6b0b1e9/fig-37.png)
...
![プロパティ名の先読み: icon問題](/images/books/b62994c6b0b1e9/fig-85.png)
...
![UIの5つの状態と遷移](/images/books/b62994c6b0b1e9/fig-07.png)
...
![Loading / Partial / Error のスケルトンパターン](/images/books/b62994c6b0b1e9/fig-77.png)
...
![Partial State: データ欠損時のフォールバック](/images/books/b62994c6b0b1e9/fig-35.png)
...
![プロパティと状態の違い: 外から渡す値と内部で管理する値](/images/books/b62994c6b0b1e9/fig-84.png)
...
![インタラクション状態: 5つの見た目を統一ルールで管理する](/images/books/b62994c6b0b1e9/fig-29.png)
...
壊れにくいコンポーネントの設計原則をひとことで言えば、「何が来ても受け止めるが、外には予測可能なものだけを出す」ということです。システム設計や通信における原則のひとつに「受け取るものには寛容に、送り出すものには厳密に」（ポステルの法則）という考え方があります。コンポーネントに当てはめると、どんな入力（長いテキスト、空データ、想定外の画像比率）が来ても壊れずに受け止めること。一方で、外に提供するレイアウト——marginを持たない、幅の振る舞いが予測可能——は厳密であるべきです。この章で扱う設計判断の多くは、この「入力に寛容、出力に厳密」の実践です。
...
![padding（内側）と margin（外側）の責任分離](/images/books/b62994c6b0b1e9/fig-19.png)
...
![区切り線: コンポーネントに含めるか、親が制御するか](/images/books/b62994c6b0b1e9/fig-38.png)
...
![Fill / Hug / Fixed の3パターン](/images/books/b62994c6b0b1e9/fig-08.png)
...
![テキストのオーバーフロー: 省略・行数制限・折り返し](/images/books/b62994c6b0b1e9/fig-64.png)
...
![コンテナのオーバーフロー: スクロール・もっと見る・切り捨て](/images/books/b62994c6b0b1e9/fig-65.png)
...
ただ、ルールに忠実に従うこと、細部を完璧にすることも、それ自体がゴールではありません。ルールの背後にあるなぜを掴むこと。その構造的な理解が、まだルールのない新しい局面でも自分で判断できる力になります。

この変更の影響範囲はどこまでか、この設計は半年後の誰かが安全に拡張できるか、この命名は意図を正しく伝えているか。こうした問いを自然に立てられるようになることは、デザインシステムの仕事に限らず、プロダクト設計のあらゆる場面で活きてきます。

これらを押さえることで、本来私たちが取り組むユーザー価値の実現にフォーカスできるようにする。細かい議論や調整に時間を使わずにデザインできることが本質的に目指すべきことです。

デザインシステムに込められた設計判断の一つひとつは、チームが良いデザインとは何かという問いに対して積み重ねてきた回答の集積でもあります。余白のリズム、色の意味の体系、インタラクションの質感。新しいメンバーがコンポーネントライブラリを使い始めるとき、そこには先人が磨き上げた美意識やクラフトマンシップが宿っています。あるデザイナーがエッジケースまで丁寧に詰めたコンポーネントは、それを使うすべての画面の品質を底上げします。デザインシステムは効率化の装置であると同時に、デザイン文化の伝達媒体です。

ベースラインが堅固であることは、創造的な冒険の前提条件でもあります。基本のパターンがシステムによって担保されているからこそ、デザイナーは安心してそこから逸脱し、新しい表現に挑戦できます。原則の章で述べた「揃えているからこそ、差異が意味を持つ」という原理は、ユーザー体験だけでなく、デザイナー自身の表現力にも当てはまります。
