...
Enumの価値は、あえて制約することにあります。String型は何でも入力できますが、自由すぎるとチームのなかでバラつきが生まれます。Enumにして選択肢を絞ることで、迷う場面が減り本質に集中できる。選択肢の体系そのものが、コンポーネントの使い方を暗に伝えてくれます。デッドライン直前のように急いでいるときにこそ、正しい選択が最も簡単であることが効きます。
